...
app.get('/', async (req, res) => {
  try {
    ...
    // Construct Notes URL server-side
    ...
    const notesUrl = `mobilenotes://quicknote?text=${encodedText}`;
        ...
        <body>
          <div class="container">
            ...
            <div class="button-group">
              ...
              <a href="${notesUrl}" class="scripture-button" onclick="handleNotesError()">Add to Notes</a>
            </div>
          </div>
          <script>
            function handleNotesError() {
              setTimeout(() => {
                if (document.hasFocus()) {
                  alert('Failed to open Notes. Please open Notes and paste the content manually.');
                }
              }, 1000);
            }
          </script>
